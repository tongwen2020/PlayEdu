...
export function getToken(): string {
  return window.localStorage.getItem("eleadinedu-frontend-token") || "";
}

export function setToken(token: string) {
  window.localStorage.setItem("eleadinedu-frontend-token", token);
}

export function clearToken() {
  window.localStorage.removeItem("eleadinedu-frontend-token");
}
...
export function getDepKey(): string {
  return window.localStorage.getItem("eleadinedu-frontend-depatmentKey") || "";
}

export function setDepKey(token: string) {
  window.localStorage.setItem("eleadinedu-frontend-depatmentKey", token);
}

export function clearDepKey() {
  window.localStorage.removeItem("eleadinedu-frontend-depatmentKey");
}
export function getDepName(): string {
  return window.localStorage.getItem("eleadinedu-frontend-depatmentName") || "";
}

export function setDepName(token: string) {
  window.localStorage.setItem("eleadinedu-frontend-depatmentName", token);
}

export function clearDepName() {
  window.localStorage.removeItem("eleadinedu-frontend-depatmentName");
}
...
export function getPlayId(): string {
  return window.localStorage.getItem("eleadinedu-play-id") || "";
}

export function savePlayId(id: string) {
  window.localStorage.setItem("eleadinedu-play-id", id);
}

export function clearPlayId() {
  window.localStorage.removeItem("eleadinedu-play-id");
}
