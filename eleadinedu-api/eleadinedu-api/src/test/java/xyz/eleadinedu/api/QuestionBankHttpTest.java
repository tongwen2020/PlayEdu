...
import xyz.eleadinedu.api.controller.backend.QuestionBankController;
import xyz.eleadinedu.api.controller.frontend.QuestionPracticeController;
...
class QuestionBankHttpTest {
    ...
    void paperSubmissionAutomaticallyGradesEveryQuestionAndIsIdempotent() {
        ...
        assertThat(ok(STUDENT + "/practice/paper/submit", request, "student-10")).isEqualTo(result);
        assertThat(
