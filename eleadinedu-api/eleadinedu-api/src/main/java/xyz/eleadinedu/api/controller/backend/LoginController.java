...
import xyz.eleadinedu.api.event.AdminUserLoginEvent;
import xyz.eleadinedu.api.request.backend.LoginRequest;
import xyz.eleadinedu.api.request.backend.PasswordChangeRequest;
...
public class LoginController {
    ...
    public JsonResponse login(@RequestBody @Validated LoginRequest loginRequest) {
        ...
        if (reqCount > 10 && !eleadineduConfig.getTesting()) {
