...
export function getToken(): string {
  return window.localStorage.getItem("eleadinedu-backend-token") || "";
}

export function setToken(token: string) {
  window.localStorage.setItem("eleadinedu-backend-token", token);
}

export function clearToken() {
  window.localStorage.removeItem("eleadinedu-backend-token");
}
