...
export function getToken(): string {
  return window.localStorage.getItem("eleadinedu-h5-token") || "";
}

export function setToken(token: string) {
  window.localStorage.setItem("eleadinedu-h5-token", token);
}

export function clearToken() {
  window.localStorage.removeItem("eleadinedu-h5-token");
}
...
export function getDepKey(): string {
  return window.localStorage.getItem("eleadinedu-h5-depatmentKey") || "";
}

export function setDepKey(token: string) {
  window.localStorage.setItem("eleadinedu-h5-depatmentKey", token);
}

export function clearDepKey() {
  window.localStorage.removeItem("eleadinedu-h5-depatmentKey");
}
export function getDepName(): string {
  return window.localStorage.getItem("eleadinedu-h5-depatmentName") || "";
}

export function setDepName(token: string) {
  window.localStorage.setItem("eleadinedu-h5-depatmentName", token);
}
